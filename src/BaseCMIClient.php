...
use Elmarzouguidev\CMI\Contracts\CMIClientInterface;
use Exception;
use Elmarzouguidev\CMI\Exceptions\InvalidArgumentException;
...
class BaseCMIClient implements CMIClientInterface
{
    ...
    private function validateConfig($config): void
    {
        ...
        if (!in_array($config['lang'], config('laravel-cmi.languages'))) {
